...
- 邮箱预设字典，键名为 `126`, `163`, `qq`, `gmail`, `outlook`, `icloud`, `proton`
...
- **Google Custom Search**（需 `GOOGLE_API_KEY` + `GOOGLE_CSE_ID`）
...
`tasks.json` 存储所有定时任务配置，手动编辑后需重启守护进程生效
